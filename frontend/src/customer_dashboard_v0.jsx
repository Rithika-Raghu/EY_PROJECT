    ...
    <div className={`min-h-screen flex bg-gradient-to-br ${theme === "dark"
      ...
      <aside className="w-72 border-r border-gray-700/40 p-6 hidden lg:flex flex-col">
        ...
        <nav className="flex-1 space-y-4 text-sm">
          ...
          <NavItem label={t("overview")} icon={<TrendingUp size={18} />} />
          <NavItem label={t("status")} icon={<Users size={18} />} />
          <NavItem label={t("apply")} icon={<Wallet size={18} />} />
          <NavItem label={t("payments")} icon={<CreditCard size={18} />} />
          <NavItem label={t("tools")} icon={<Calculator size={18} />} />
          <NavItem label={t("documents")} icon={<FileText size={18} />} />
          <NavItem label={t("insurance")} icon={<ShieldCheck size={18} />} />
